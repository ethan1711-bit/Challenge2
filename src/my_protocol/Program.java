...
/**
 * Entry point of the program. Starts the client and links the used RDT
 * protocol.
 *
...
Program {
    ...
    private static String groupToken = "65b7ea01-04c7-4e29-8c67-c6cd8ff43dfa";
        ...
        try {
            ...
            if (client.isSimulationFinished()) {
                ...
                if (startRequested) {
                    ...
                    System.out.println(
                            "[FRAMEWORK] Running protocol implementation as receiver...");
